                                ...
                                <div class="x_content">
                                    <div class="row" style="margin-bottom: 10px">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <?php echo anchor(site_url('penduduk/create'), '<i class="fa fa-plus-square"> </i> Tambah Wilayah', 'class="btn btn-primary"'); ?>
                                        <!--
                                    ...
                                    <table class="table table-bordered table-striped" id="mytable">
                                        ...
                                        foreach ($penduduk_data as $penduduk)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <?php 
                                                echo anchor(site_url('data_tanah/penduduk/'.$penduduk->id_penduduk),'<i class="fa fa-eye"></i> Data Wilayah', 'class="btn btn-success btn-xs"'); 
