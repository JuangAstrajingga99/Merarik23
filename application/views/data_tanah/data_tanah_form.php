                                ...
                                <div class="x_content">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="int">Nama Wilayah<?php echo form_error('id_penduduk') ?></label>
                                            <input disabled="disabled" type="text" class="form-control" placeholder="<?php echo $penduduk->nama ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="int">Jenis Wisata <?php echo form_error('id_jenis_bangunan') ?></label>
                                       ...
                                       <div class="form-group">
                                            <label for="varchar">Harga Tiket <?php echo form_error('persil') ?></label>
                                            <input type="text" class="form-control" name="persil" id="persil" placeholder="Harga Tiket" value="<?php echo $persil; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label for="varchar">Luas Wisata <?php echo form_error('luas_tanah') ?></label>
                                            <input type="text" class="form-control" name="luas_tanah" id="luas_tanah" placeholder="Luas Wisata" value="<?php echo $luas_tanah; ?>" placeholder="m2" />
                                        </div>
                                            <script>
                                              $(function() {
