            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div class="navbar nav_title" style="border: 0;">
                        <center><a href="#" class="site_title"><span>SIG WISATA</span></a></center>
                    </div>
                            ...
                            <ul class="nav side-menu">
                                <?php $group = 3; 
                                    if ($this->ion_auth->in_group($group)): ?>
                                        <li><a href="<?php echo base_url('data_wisata')  ?>"><i class="fa fa-home"></i>Master Data Wisata</a></li>
                                    
                                    <?php else: ?>
                                        <li><a href="<?php echo base_url('dashboard')  ?>"><i class="fa fa-tachometer"></i>Dashboard</a></li>
                                        <li><a href="<?php echo base_url('wilayah')  ?>"><i class="fa fa-home"></i>Data Wilayah</a></li>
                                        <li><a href="<?php echo base_url('data_wisata')  ?>"><i class="fa fa-home"></i>Master Data Wilayah Wisata</a></li>
                                        <li><a href="<?php echo base_url('berita')  ?>"><i class="fa fa-newspaper-o"></i>Berita</a></li>
                                        <li><a href="<?php echo base_url('jenis_wisata')  ?>"><i class="fa fa-university"></i>Jenis Wisata</a></li>
