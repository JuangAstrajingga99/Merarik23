                        ...
                        <div class="col-md-12">
                            <div class="x_panel">
                                ...
                                <?php echo form_open_multipart($action);?>
                                    ...
                                    <div class="form-group">
                                        <label for="varchar">No Telepon <?php echo form_error('nomor_telepon') ?></label>
                                        <input type="text" class="form-control" name="nomor_telepon" id="nomor_telepon" placeholder="nomor_telepon" value="<?php echo $phone; ?>" />
                                    </div>
                                    <div class="form-group">
