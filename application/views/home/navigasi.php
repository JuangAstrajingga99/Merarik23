                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs w100 phone right">
                            <a href="<?php echo base_url('home/contact') ?>" class="email hidden-xs"><i class="fa icon-envelope-open ph-size" aria-hidden="true"></i> nusatenggaratimur@gmail.com</a>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 logo">
                            <a href="<?php echo base_url() ?>">
                                <h3 id="logotop">SIGWISATA</h3>
                            <!-- /.logo 
                                <img src="<?php echo base_url()?>assets/images/logo1.png" alt="logo" id="logotop" />
                            -->
                            </a>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li id="Peta" class="">
                                                <a href="<?php echo base_url('home/peta') ?>" class="remove-border hvr-underline-from-center">Peta Wilayah Wisata </a>
                                            </li>
                                            <li id="Contact" class="">
