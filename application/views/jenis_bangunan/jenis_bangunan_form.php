                ...
                <div class="">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Form <small><?php echo $button ?> Jenis Wisata</small></h2>
                                ...
                                <div class="x_content">
                                    <?php echo form_open_multipart($action);?>
                                        <div class="form-group">
                                            <label for="varchar">Nama Wisata <?php echo form_error('nama_bangunan') ?></label>
                                            <input type="text" class="form-control" name="nama_bangunan" id="nama_bangunan" placeholder="Nama Wisata" value="<?php echo $nama_bangunan; ?>" />
                                        </div>
                                        <div class="form-group">
