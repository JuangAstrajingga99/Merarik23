...
class wilayah_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $this->db->like('id_wilayah', $q);
	$this->db->or_like('no_wilayah', $q);
	$this->db->or_like('nama_wilayah', $q);
	$this->db->or_like('alamat', $q);
	$this->db->or_like('no_telepon_pengelola', $q);
    ...
    function cek_no_induk($no_wilayah)
    {
        $this->db->where('no_wilayah', $no_wilayah);
